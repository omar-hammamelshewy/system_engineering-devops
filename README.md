...
### 🔹 [0x00-shell_basics](https://github.com/trxomv/system_engineering-devops/blob/main/0x00-shell_basics/README.md)
Covers foundational Linux commands:
- `pwd`, `ls`, `cd`, etc.
- Listing hidden files & long format
- Basic scripting execution
---
### 🔹 [0x01-shell_permissions](https://github.com/trxomv/system_engineering-devops/blob/main/0x01-shell_permissions/README.md)
Learn how to:
- Switch users (`su`).
...
---
### 🔹 [0x02-shell_redirections](https://github.com/trxomv/system_engineering-devops/blob/main/0x02-shell_redirections/README.md)
...
### 🔧 3. Make a script executable (only once)
```bash
chmod +x script_name
```
